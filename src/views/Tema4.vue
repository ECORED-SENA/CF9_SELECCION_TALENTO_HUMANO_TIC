  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5 
    ...
    .crd.crd--lightPurple.mb-5(data-aos="slide-right")
      .row.align-items-center
        ...
        .col
          p.mb-0 Lo anteriormente descrito son los primeros insumos que hacen parte de la planificación del proceso de selección, tal como se muestra en la siguiente figura.
    ...
    .bg_gris--h1
      .row.mb-4.pt-5
        .col-lg-8
          p.mb-4 Para tal efecto, es relevante que se cuente con un inventario de personas, información que permite conocer la trayectoria en cuanto a conocimiento, desarrollo de competencias y desempeño que ha tenido el trabajador al interior de la organización, y permite analizar la estructura de personal, realizar previsiones, planificar recursos y contabilizarlos. 
      ...
      .row.m-0.align-items-center.justify-content-between        
        .col-12
          .bloque-texto-a__texto.p-4
            p.mb-0 #[span.bold--blue Cuando se habla de reclutamiento de personal, se hace referencia a:] las acciones que realiza una organización con el fin de atraer los candidatos idóneos para el puesto de trabajo que la empresa requiere, teniendo en cuenta un perfil de búsqueda diseñado previamente; para ello, utiliza diversas técnicas que le permiten divulgar y ofrecer oportunidad de empleo en el mercado de recursos humanos. 

    p.mb-5 Atracción es un concepto que tiene que ver con la cultura organizacional y sus prácticas, las cuales permiten generar motivación en los potenciales candidatos para aplicar y pertenecer a la organización.

    h4.hg--title.mb-4 ¿Cómo inicia el proceso de reclutamiento?
      ...
      SlyderA(tipo="b")
        .row.align-items-center.pt-4
          .col-md-5.mb-4.mb-lg-0
            figure
              img(src='@/assets/curso/tema4/t4_04.svg', alt='').m-auto.img350                          
          .col-md-7
            .bigNumber(data-number="01")
              p.mb-0 Inicia cuando se genera una necesidad en un área al interior de la organización, esta necesidad puede sobrevenir por situaciones tales como creación de un cargo nuevo, jubilaciones, ascensos, renuncias, despidos, transferencias, etc. 

        .row.align-items-center.pt-4                                  
          .col-md-7
            .bigNumber(data-number="02")
              p.mb-0 Cada jefe de área es el encargado de informar al área de Talento Humano de la vacante que tiene; esta solicitud la formaliza utilizando el documento de requisición de cargo, y es a través de esta solicitud cuando Talento Humano procede a realizar la revisión de la descripción y perfil del cargo. Existe la posibilidad de que en la organización exista esta descripción y perfil; si es así, se procede a hacer la revisión de este junto con el jefe inmediato, y verificar si requiere ajustes de acuerdo con la necesidad. En caso de no existir, esta información debe obtenerse.   
          .col-md-5
            figure
              img(src='@/assets/curso/tema4/t4_05.svg', alt='').m-auto.img350 
        ...
        .row.align-items-center.pt-4                                   
          .col-md-7
            .bigNumber(data-number="04")
              p.mb-0 Adicionalmente, el perfil del cargo debe contener información sobre el conocimiento, experiencia, habilidades, destrezas y características personales (actitudes, motivaciones), en consecuencia, se procede a asignar las competencias para cada puesto de trabajo; de igual modo, para que esto sea posible, debe diseñarse previamente un modelo de competencias. 
          .col-md-5
            figure
    ...
    .row.align-items-center.mb-5
      .col-auto
        figure
          img(src="@/assets/curso/dots_02.svg", alt="alt").img35
      .col
        p.mb-0 #[span.bold_purple Ahora, para alistar candidatos según el perfil de competencias y necesidades de la organización, se debe partir de la Etapa preparatoria, la cual consiste en la determinación de las necesidades de personal; a partir de ella, el área que tiene la vacante genera la solicitud o requisición, y de esta manera se formaliza la demanda para que talento humano dé inicio al proceso de preselección; a continuación, se lleva a cabo el análisis y descripción de los cargos u ocupaciones; elaboración de las especificaciones del cargo, siempre y cuando este no haya sido proyectado por la empresa. Por otro lado, si ya existe la descripción y perfil del cargo, se debe analizar junto con el jefe inmediato y decidir si requiere de ajustes teniendo en cuenta la requisición.]
    ...
    .row.mb-5
      ...
      .col-lg-7
        ...
        p El reclutamiento puede ser:
        
        LineaTiempoD.color-amarillo
          p(numero="1" titulo="Interno") Se refiere a atraer personas dentro de la misma organización, decisión que puede significar una promoción para el trabajador, transferencia a otras actividades más complejas, y de esta forma se genera un enriquecimiento de cargo para el empleado.

          p(numero="2" titulo="Externo") Apunta a la atracción de candidatos en el mercado de talento humano.
      ...
      .row.align-items-center
        .col-auto
          figure
            img(src="@/assets/curso/dots_01.svg", alt="alt").img35
        .col
          p.mb-0 Cada una de estas opciones tiene su propio conjunto de planes de talento humano, que pueden ir de capacitaciones hasta #[i coaching]. Es de anotar que tanto el inventario de personal como el plan de carrera facilitan la disponibilidad de candidatos internos.

    p.mb-5 Con todo esto, es importante evaluar los beneficios de cada tipo de reclutamiento, para tomar la decisión más acertada en el logro de la estrategia organizacional.
    ...
    .tabla-a.color-acento-amarillo.mb-5
      table
        ...
        tbody
          ...
          tr
            td
              | Se aprovecha la inversi&oacute;n en capacitaci&oacute;n de otras empresas y del mismo candidato.
            td El tiempo que requiere es mayor que el reclutamiento interno.

    .bg_gris--h1.mb-4
      .row.mb-4.pt-4
        .col-lg-9
          h4.hg--title Fuentes de reclutamiento
    ...
    .bg_gradient--01.pb-5
      p.mb-5 A continuación, se presentan algunas de ellas:

      SlyderF.mb-5(columnas="col-lg-6 col-xl-4")
        .crd.crd--white.p-4
          .row.justify-content-center.mb-3
            .col-8
              img(src='@/assets/curso/tema4/t4_14.svg').m-auto.img90          
          p.text-center Publicación de anuncios mediante portales o bolsas de empleo virtuales en Internet.

        .crd.crd--white.p-4
          .row.justify-content-center.mb-3
            .col-8
              img(src='@/assets/curso/tema4/t4_15.svg').m-auto.img90          
          p.text-center Bases de datos de hojas de vida propias para cada organización.

        .crd.crd--white.p-4
          .row.justify-content-center.mb-3
            .col-8
              img(src='@/assets/curso/tema4/t4_16.svg').m-auto.img90          
          p.text-center Ferias de empleo.

        .crd.crd--white.p-4
          .row.justify-content-center.mb-3
            .col-8
              img(src='@/assets/curso/tema4/t4_17.svg').m-auto.img90          
          p.text-center Programas de referidos. 

        .crd.crd--white.p-4
          .row.justify-content-center.mb-3
            .col-8
              img(src='@/assets/curso/tema4/t4_14.svg').m-auto.img90          
          p.text-center Consultoras de talento humano, #[i Head-hunter].

        .crd.crd--white.p-4
          .row.justify-content-center.mb-3
            .col-8
              img(src='@/assets/curso/tema4/t4_15.svg').m-auto.img90          
          p.text-center Aplicaciones web. (Elempleo.com, CompuTrabajo, Indeed, Magneto, etc.) 

        .crd.crd--white.p-4
          .row.justify-content-center.mb-3
            .col-8
              img(src='@/assets/curso/tema4/t4_16.svg').m-auto.img90          
          p.text-center Agencia Pública de Empleo (APE) del SENA.

        .crd.crd--white.p-4
          .row.justify-content-center.mb-3
            .col-8
              img(src='@/assets/curso/tema4/t4_17.svg').m-auto.img90          
          p.text-center Universidades o instituciones de educación superior.

        .crd.crd--white.p-4
          .row.justify-content-center.mb-3
            .col-8
              img(src='@/assets/curso/tema4/t4_14.svg').m-auto.img90          
          p.text-center Redes sociales profesionales, como: LinkedIn, Facebook, Twitter, Social Recruiting, Networking (siendo las más completas LinkedIn, Social Recruiting y Networking).

        .crd.crd--white.p-4
          .row.justify-content-center.mb-3
            .col-8
              img(src='@/assets/curso/tema4/t4_15.svg').m-auto.img90          
          p.text-center #[i Inbound recruiting].
        ...
        .row.align-items-center
          .col-auto
            figure
              img(src="@/assets/curso/dots_01.svg", alt="alt").img35
          .col
            p.mb-0 Dentro de la información a la que tiene acceso el reclutador, se tiene: historia profesional, conocimientos, competencias, proyectos personales y preferencias; se puede verificar si el candidato se encuentra desempleado o está activo; si se encuentra activo, es necesario indagar si está interesado en cambiar o no de empleo, esta información puede ser relevante porque puede influir en la motivación o no del candidato para la aplicación en el proceso.
    ...
    .row.align-items-center.mb-5
      .col-auto
        figure
          img(src="@/assets/curso/dots_02.svg", alt="alt").img35
      .col
        p.mb-0 #[span.bold_purple La globalización ha generado en las organizaciones la necesidad de transformarse para ser más competitivas en el mercado, abriendo la puerta a las nuevas tendencias, como son: el uso de las tecnologías de información y comunicación (TIC) en el proceso de reclutamiento de personal, surgiendo así el e-reclutamiento, sistema que permite atraer candidatos a través de Internet.]
          ...
          .row.align-items-center
            .col-auto
              figure
                img(src="@/assets/curso/dots_01.svg", alt="alt").img35
            .col
              p.mb-0 #[span.bold--blue Las TIC generan una ventaja dentro del mercado laboral y de talento humano al permitir agilizar y hacer más eficientes los procesos; teniendo en cuenta que todos los procesos de talento humano dependen del proceso de selección de personal, el e-reclutamiento permite, entre otras cosas, realizar entrevistas por Internet.]    
