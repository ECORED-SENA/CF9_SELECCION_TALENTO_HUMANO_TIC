  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
          ...
          .row.justify-content-center.justify-content-lg-start
            .col-auto.mb-4
              .crd.crd--white.crd--145
                figure.mb-2
                  img(src="@/assets/curso/tema3/t3_02.svg", alt="alt").m-auto.img60
                h6.mb-1.text-center Materiales
            .col-auto.mb-4
              .crd.crd--white.crd--145
                figure.mb-2
                  img(src="@/assets/curso/tema3/t3_03.svg", alt="alt").m-auto.img60
                h6.mb-1.text-center Financieros
            .col-auto.mb-4
              .crd.crd--white.crd--145
                figure.mb-2
                  img(src="@/assets/curso/tema3/t3_04.svg", alt="alt").m-auto.img60
                h6.mb-1.text-center Humanos
            .col-auto.mb-4
              .crd.crd--white.crd--145
                figure.mb-2
                  img(src="@/assets/curso/tema3/t3_05.svg", alt="alt").m-auto.img60
    ...
    .bg_gris--h0.mb-4
      .row.align-items-center.pt-4
        .col-lg-8
          p.mb-4 La planeación de talento humano es la que determina el recurso humano que necesita y optimiza la disponibilidad de candidatos internos, información que se aprovecha para la toma de decisiones del aprovisionamiento (fuentes internas o externas), de manera que la organización cuente con los postulantes calificados, en los tiempos solicitados por el cliente interno, gestión que impacta de manera directa el presupuesto previsto. En este sentido, el responsable del proceso de selección debe considerar los recursos disponibles, los costos involucrados y los resultados esperados.
            ...
            .col-lg-10
              ...
              .avatarHr--crd.mb-4(data-aos="slide-left")
                .row.align-items-center
                  .col-auto
                    figure
                      img(src="@/assets/curso/tema3/t3_12.svg", alt="alt").m-auto.img90
                  .col
                    p.mb-0 #[span.bold_purple Cualitativos:] responden a quiénes serán los responsables del proceso. 
    
    .bloque-texto-a.bt_clr_02.mb-5 
      .row.m-0.align-items-center.justify-content-between        
        .col-12
          .bloque-texto-a__texto.p-4
            p.mb-0 #[span.bold--blue Tenga en cuenta:] el presupuesto es una herramienta de gestión que permite optimizar los recursos con que la empresa cuenta y ser utilizado con agudeza para beneficio en el logro de los objetivos y políticas planteadas.
      ...
      .row.align-items-center.mb-4.pt-5
        .col-lg-8.order-2.order-lg-1
          .row.align-items-center.mb-5
            .col-auto
              figure
                img(src="@/assets/curso/dots_05.svg", alt="alt").img90
            .col
    ...
    .row.justify-content-center.mb-5
      ...
      .col-lg-10.neg--mt
        .crd.crd--grGray 
          p.mb-0 En la siguiente tabla, se puede observar un ejemplo de una tabla de presupuesto del proceso, donde, en la primera columna, está el detalle de los elementos que hacen parte del proceso de selección; en la segunda columna, la meta de realización; se colocan las fechas de cumplimiento de cada paso, siguiendo con el nombre del cargo de quien responde por la actividad, horas invertidas, y los costos se presupuestan de acuerdo con el salario de la persona responsable.

    .titulo-sexto.color-acento-contenido
      h5 Tabla 1.
      span  Ejemplo tabla de presupuesto del proceso
    .tabla-a.color-acento-amarillo.mb-5 
      table
        ...
        tbody
          tr
            td Reclutamiento 
            td.text-center 23/11/2021
            td.text-center  Analista TH
            td.text-center  16 horas 
          ...
          tr.Tbg--gray
            ...
            td.text-center  $417.000
          tr
            td Revisi&oacute;n CV
            td.text-center  20/11/2021
            td.text-center  Analista TH
          ...
          tr
            td Entrevistas 
            td.text-center  28/11/2021
            td.text-center  Cliente interno 
            td.text-center  16 horas
